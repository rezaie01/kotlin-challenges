...
class TortoiseRacing {
    private fun solve(v1: Int, v2: Int, g: Int): IntArray {
    ...
    fun test() {
        println("Basic Tests")
        assertArrayEquals(intArrayOf(0, 32, 18), solve(720, 850, 70))
        assertArrayEquals(intArrayOf(3, 21, 49), solve(80, 91, 37))
        assertArrayEquals(intArrayOf(), solve(820, 81, 550))
    }
}